...
public class Map {
    ...
    private Map(){}
    public static Map getInstance(Context ctx){
        if (null==instance){
            instance = new Map();
        }
    ...
    public static Map getInstance(Context ctx, MapView mapView) {
        if (null==instance){
            instance = new Map();
            instance.context = ctx;
    ...
    public static Map getInstance(LocationLoadedCallback callback, MapView mapView) {
        if (null!=instance){
            instance.mapView = mapView;
    ...
    public static Map getInstance(MapView mapView) {
        instance.mapView = mapView;
        return instance;
    }
    ...
    private void showAddClearDialog(Marker m) {
        AlertDialog alertDialog  = new AlertDialog.Builder(context)
                ...
                .setPositiveButton("Add to bookmark", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {

                    }
                })
                .setPositiveButtonIcon(getContext().getDrawable(R.drawable.ic_baseline_bookmark_24))
