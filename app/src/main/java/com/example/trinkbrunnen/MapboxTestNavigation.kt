...
class MapboxTestNavigation : AppCompatActivity() {
     ...
     */
    private lateinit var binding: ActivityMapboxTestNavigationBinding
...
// and later when a route is set also receiving route progress updates
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapboxTestNavigationBinding.inflate(layoutInflater)
        setContentView(binding.root)

        //val geoPointExtra = intent.getParcelableExtra<GeoPointExtra>("destination")
...
// add long click listener that search for a route to the clicked destination
           ...
           /* if (geoPointExtra != null) {
                Log.d("new intent", "onCreate: ->........"+geoPointExtra.location.toDoubleString())
            }
            if (geoPointExtra != null) {
                findRoute(Point.fromLngLat(geoPointExtra.longitude,geoPointExtra.latitude))
            }*/

            Log.d("TAG", "onCreate: -........> before finding route")
    ...
    private fun findRoute(destination: Point) {
        Log.d("TAG", "findRoute: ------------------->started$destination")
